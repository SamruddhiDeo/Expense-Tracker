...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `income` (`title`, `amount`, `date`, `category`, `username`) VALUES ('$title', '$amount', '$date', '$category', '$username');";
...
<body>
    ...
    <div class="container addbox">
        ...
        <form class="mt-3" action="addincome.php" method="post">
            ...
            <div class='form-group'>
                ...
                <div class='form-group '>
                    <div class='categorybox incomecategorybox'>
                        ...
                        <div class='form-check'>
                            <input class='form-check-input' type='radio' name='category' id='category' value='Bonus'>
                            <label class='form-check-label' for='category'>
                                Bonus
                            </label>
                        </div>
                        ...
                        <div class='form-check'>
                            <input class='form-check-input' type='radio' name='category' id='category' value='Award'>
                            <label class='form-check-label' for='category'>
                                Award
                            </label>
                        </div>
                        <div class='form-check'>
                            <input class='form-check-input' type='radio' name='category' id='category' value='Dividend'>
                            <label class='form-check-label' for='category'>
                                Dividend
                            </label>
                        </div>
                        ...
                        <div class='form-check'>
                            <input class='form-check-input' type='radio' name='category' id='category' value='Lottery'>
                            <label class='form-check-label' for='category'>
                                Lottery
                            </label>
                        </div>
